...
quotes = {
    "For it is in giving that we receive.": "St. Francis of Assisi, patron saint of animals and ecology",
    ...
    "Entrenched in both ancient and modern cultural tradition, the pursuit of happiness is a popular preoccupation around the world.": "Ed Diener",
    ...
    "If there is no God, then everything is permitted.": "Fyodor Dostoevsky - Brothers Karamazov",
    "If it weren't for the fact that the TV set and the refrigerator are so far apart, some of us wouldn't get any exercise at all.": "Joey Adams",
    "Any justice which is only justice soon degenerates into something less than justice. It must be saved by something which is more than justice.": "Reinhold Niebuhr",
    ...
    "Jenseits von richtig und falsch liegt ein Ort, an dem treffen wir uns.": "Rūmī",
    "My German engineer, I think, is a fool. He thinks nothing empirical is knowable. I asked him to admit that there was no rhinoceros in the room, but he wouldn't.": "Bertrand Russell on early Ludwig Wittgenstein",
    ...
    "A designer knows that they have achieved perfection not when there is nothing left to add, but when there is nothing left to take away.": "de Saint-Exupery's Law of Design",
    "Better is the enemy of good.": "Edison's Law",
    "Half of everything you hear in a classroom is crap. Education is figuring out which half is which.": "Larrabee's Law",
    "When the hardware is working perfectly, the really important visitors don't show up.": "Atkin's Law of Demonstrations",
    "A good plan violently executed now is better than a perfect plan next week.": "Patton's Law of Program Planning",
    "Do what you can, where you are, with what you have.": "Roosevelt's Law of Task Planning",
    "It is difficult to get a man to understand something when his salary depends on his not understanding it.": "Upton Sinclair",
    "You always make your own fun. If you don't make it yourself, it ain't fun, it's entertainment.": "David Mamet - State and Main",
    ...
    "Go and spread seeds on the tops of mountains — may the birds not die of starvation in a Muslim country.": "Umar ibn Abd al-Aziz (the 8th Caliph of the Umayyad Caliphate)",
